...
- **Backend APIs:** Building REST APIs with FastAPI and Flask, handling complex business logic and integrations
- **Data Pipelines:** Creating and maintaining data pipelines for large-scale integrations
- **Microservices:** Designing systems with proper separation of concerns and async processing
- **Database Work:** Modeling and optimizing relational (PostgreSQL, MySQL) and NoSQL databases (MongoDB, Elasticsearch)
- **Automations:** Building bots and scripts to eliminate manual work in data flows
