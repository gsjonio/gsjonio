...
- ⚡ **FastAPI Expert:** Designing high-throughput asynchronous APIs.
- 🗄️ **Database Specialist:** Skilled in both Relational (**PostgreSQL**, **Oracle**) and NoSQL (**MongoDB**).
- ☁️ **Cloud Native:** Hands-on experience with **AWS** and **Oracle Cloud (OCI)**.
- 🐳 **DevOps Ready:** Efficient at containerizing applications using **Docker**.
